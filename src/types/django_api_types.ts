...
export type CartItemRequestType = z.infer<
  AllGeneratedSchemas["CartItemRequest"]
>;
export type PatchedCartItemRequestType = z.infer<
  AllGeneratedSchemas["PatchedCartItemRequest"]
>;
...
export type MenuItemRequestType = z.infer<
  AllGeneratedSchemas["MenuItemRequest"]
>;
